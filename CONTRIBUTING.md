...
3.  **Commit and Push Incrementally**: Commit in verified logical increments as you work and push after each commit, so nothing lives only in your local worktree. Keep the branch buildable at every commit. See [`AGENTS.md`](AGENTS.md) for the rationale.
4.  **Code Style**:
