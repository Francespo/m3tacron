...
> Agent note: work through this issue with the `work-order` conventions in `.agents/skills/work-order/SKILL.md`. Priority and Size live in project fields, not in the body. PR targets base branch `dev` and closes this issue.
