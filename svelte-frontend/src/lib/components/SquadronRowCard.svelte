...
<div
    class="flex relative bg-terminal-panel border border-[#ffffff14] rounded-lg overflow-hidden group hover:bg-[rgba(255,255,255,0.02)] transition-colors cursor-pointer"
